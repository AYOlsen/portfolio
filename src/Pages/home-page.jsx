    ...
    <>
      <section className="bg-background h-[670px] relative">
        <div className='max-width mx-auto pb-6'>
          <div className=''>
            <Banner
              className="home-banner absolute w-[400px]"  
              title={
                <>
                  Hey, I am<br />
                  Anna-Yodit Olsen
            ...
            />
            <div className='flex gap-6 absolute bottom-44 left-[10%]'>
              <Button 
                className="home-button bg-brown-200 hover:bg-brown-400 text-white rounded-md px-4 py-2"
                text="About Me"
                link={ROUTES.About}
              />
              
              <Button 
                className="home-button bg-green-300 hover:bg-green-500 text-white rounded-md px-4 py-2"
                text="My projects"
                link={ROUTES.Project}
              />
            </div>
      ...
      <section className='bg-green-200 py-12'>
        <div className='border-t-8 border-brown-700 py-8'>
          <div className='max-width mx-auto text-brown-900 my-16'>
            <h2 className='text-brown-700 text-center mb-20'>Recent Work</h2>

            {projectData && projectData.projects && projectData.projects.length > 0 && (
              <ul className='flex gap-x-5 justify-center mb-24'>
                {projectData.projects.map((project) => (   
                  <li key={project.id} id={project.id} className="rounded-md">
                    <LatestProjectCard 
                      title={project.title}
